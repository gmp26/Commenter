...
describe 'Service: gravatarFactory', (_) ->
  ...
  it 'should convert an email to a gravatar url', (_) ->
    ...
    .toBe "http://www.gravatar.com/avatar/7d50863de4f9b22f19c71b501f09ff86?d=retro&s=40"
  ...
  it 'should accept alternative default', (_) ->
    ...
    .toBe "http://www.gravatar.com/avatar/7d50863de4f9b22f19c71b501f09ff86?d=identicon&s=40"
